<div class='post-section post-share-buttons'>
	<h4 class='post-section-title'>
		<i class="fa fa-share-alt"></i> <?php esc_html__( 'SHARE:', 'flatnews' ); ?>
	</h4>
	<div class='post-share-buttons-holder'>
		<?php if (!flatnews_is_IE()) : ?>
		<!--[if !IE]> -->
		...
		<div class="ie-sharing-buttons">
			<a href="<?php echo esc_url('https://twitter.com/share?url='. get_the_permalink().'&amp;amp;text=Simple%20Share%20Buttons&amp;amp;hashtags=simplesharebuttons');?>" target="_blank">
				<img src="<?php echo esc_url(FLATNEWS_THEME_URL_IMAGES .'ie-share-twiiter.png');?>" alt="<?php esc_attr_e('Twitter', 'flatnews');?>" />
			</a>		

			<a href="<?php echo esc_url('https://www.facebook.com/sharer.php?u='.get_the_permalink());?>" target="_blank">
				<img src="<?php echo esc_url(FLATNEWS_THEME_URL_IMAGES.'ie-share-facebook.png');?>" alt="<?php esc_attr_e('Facebook', 'flatnews');?>" />
			</a>							    

			<a href="<?php echo esc_url('https://plus.google.com/share?url='.get_the_permalink()); ?>" target="_blank">
				<img src="<?php echo esc_url(FLATNEWS_THEME_URL_IMAGES.'ie-share-google-plus.png');?>" alt="<?php esc_attr_e('Google', 'flatnews');?>" />
			</a>							    

			<a href="<?php echo esc_url('https://pinterest.com/pin/create/button/?url='.get_the_permalink()); ?>">
				<img src="<?php echo esc_url(FLATNEWS_THEME_URL_IMAGES.'ie-share-pinterest.png');?>" alt="<?php esc_attr_e('Pinterest', 'flatnews');?>" />
			</a>
